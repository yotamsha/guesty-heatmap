...
angular.module('myApp.services')
    .service('AirbnbAPIService', ['$http','$q', function ($http, $q) {
        ...
        function _getListingsPageByLocation(location, offset){
            console.log("requesting with offset: "+ offset);
        ...
        var Service = {
            getListingsByLocation: function (location) {
                ...
                //var batchRequests = [];
/*                for (var offset = 0; offset < RESULTS_LIMIT; offset+=PAGE_LIMIT){
                    batchRequests = _getListingsPagesBatch(location, offset);
                }*/
